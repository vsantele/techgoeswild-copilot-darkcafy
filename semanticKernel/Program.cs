...
skBuilder.Services.AddLogging(c => c.SetMinimumLevel(LogLevel.Information).AddDebug());
skBuilder.Services.AddChatCompletionService(kernelSettings);
skBuilder.Services.AddSingleton(kernelSettings);
skBuilder.Plugins.AddFromType<CoffeePlugin>();
skBuilder.Plugins.AddFromType<SongPlugin>();
skBuilder.Services.AddSingleton<SpotifyService>();
