...
public class KernelSettings
{
    ...
    public string SystemPrompt { get; set; } = "Tu es un assistant amical, intelligent et curieux qui est bon en conversation. Tu sais faire le café et jouer de la musique.";
    ...
    [JsonPropertyName("darkCafyUrl")]
    public string DarkCafyUrl { get; set; } = string.Empty;
